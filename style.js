var productList = [
  ...
  function renderClothstore(thumbnailUrl,clothName,clothColor,clothPrice)
  {
    var cardContainer = document.getElementById('clothingCards');
    ...
    thumbnailImg.alt = "Clothing design";
    thumbnail.appendChild(thumbnailImg);
    details = document.createElement("div");
    details.className = "details"
    clothsName = document.createElement('h3');
    clothsName.innerHTML =clothName;
    details.appendChild(clothsName);
    clothsColor = document.createElement('h4');
    clothsColor.innerHTML =clothColor;
    details.appendChild(clothsColor);
    clothsPrice = document.createElement('h5');
    clothsPrice.innerHTML = clothPrice;
    details.appendChild(clothsPrice);
  ...
  for (let i = 0; i < 5; i++) {
    ...
    renderClothstore(productList[i].preview,productList[i].name,
      productList[i].brand,productList[i].price);
  }
  function renderClothstore1(thumbnailUrl,clothName,clothColor,clothPrice)
  {
    var cardContainer = document.getElementById('acessor-Cards');
    cardItem = document.createElement('div');
    cardItem.className = "card";
    thumbnail = document.createElement('div');
    thumbnail.className = "img";
  ...
  for (let i = 5; i < productList.length; i++) {
    ...
    renderClothstore1(productList[i].preview,productList[i].name,
      productList[i].brand,productList[i].price);
  }
